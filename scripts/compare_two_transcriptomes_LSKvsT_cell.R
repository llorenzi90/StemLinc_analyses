...
tracking_path="outputs/gffcompare/LSKvsT_cell.tracking"
...
tr2_path="outputs/transcriptome_characterization/T_cell.combined/T_cell.combined_annotated_tracking.tsv"
# 3. sample names
sample_names=c("LSK","T_cell")
