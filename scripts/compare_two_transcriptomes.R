...
# inputs:
# -tracking file of the combined transcriptome from both samples
tracking_path="outputs/gffcompare/SLvsKli_LSK.tracking"
tracking=read.table(tracking_path)

tr1_path="outputs/transcriptome_characterization/LSK_StemLinc.combined/LSK_StemLinc.combined_annotated_tracking.tsv"
