...
gene_level_data_path <- args[2] # "outputs/transcriptome_characterization/LSK_StemLinc.combined/LSK_StemLinc.combined_annotated_tracking.gene_level_info.20240930_173216.tsv"
...
out_path_closest_class <- paste0("outputs/",
                                 gsub(".tsv",".closest_PCGs.txt",basename(query_data_path)))
