...
mm39_genome='/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/references/mouse/genomes/mm39.fa'
...
CAGE_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/FANTOM5_CAGE/TSS_mouse.liftOver.mm39.bed'
...
cistromes_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/cistromes/ALL_TFs_mm39_cistrome.bed'
...
source_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/Enhancer_data/Enhancer_atlas_LSK.mm39.bed'
...
source_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/Enhancer_data/FANTOM5/mouse_permissive_enhancers_phase_1_and_2.mm39.bed'
...
source_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/ChIP_seq_data/me3_marks_GSE47765_HSCs_Luo/mm39_beds'
...
linkdir="data/public_data/ChIP_seq_data/"
dir.create(linkdir,recursive = T)
#source_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.13,share=investigacio/Cuartero Group/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/ChIP_seq_data/K27ac_K4me1_GSE63276_RAW_Luo/mm39_beds/GSM1544999_m24_H3K27ac.narrowPeak.mm39.bed'
source_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/ChIP_seq_data/K27ac_K4me1_GSE63276_RAW_Luo/mm39_beds/GSM1544999_m24_H3K27ac.narrowPeak.mm39.bed'
...
linkdir="data/public_data/ChIP_seq_data/"
dir.create(linkdir,recursive = T)
#source_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.13,share=investigacio/Cuartero Group/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/ChIP_seq_data/K27ac_K4me1_GSE63276_RAW_Luo/mm39_beds/GSM1545000_m24_H3K4me1.narrowPeak.mm39.bed'
source_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/ChIP_seq_data/K27ac_K4me1_GSE63276_RAW_Luo/mm39_beds/GSM1545000_m24_H3K4me1.narrowPeak.mm39.bed'
...
source_data='/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/polyASite/atlas.clusters.2.0.chr.liftOver.mm39.bed'
system(paste0("ln -s '",source_data,"' ",linkdir))
...
source_data <- '/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/metadata_RNA_seq_studies/Delas_et_al/Delas_all_lncRNAs_2017_from_website.txt'
system(paste0("ln -s '",source_data,"' ",linkdir))
...
source_data <- '/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/metadata_RNA_seq_studies/Delas_et_al/elife-25607-supp1-v2_Delas_lncRNA_catalog.liftovermm39.gtf'
system(paste0("ln -s '",source_data,"' ",linkdir))
...
source_data <- '/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/Experimento4_LSK_190224/analyses/strtie_transcriptome_assembly/gffcompare/StemLincpotNovLSK_vs_Delas/StemLincpotNovLSK_vs_Delas.LSK_StemLinc.combined.gtf.tmap'
system(paste0("ln -s '",source_data,"' ",linkdir))
...
source_data <- '/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/metadata_RNA_seq_studies/Delas_et_al/elife-25607-supp2-v2.xls'
system(paste0("ln -s '",source_data,"' ",linkdir))
...
source_data <- '/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/metadata_RNA_seq_studies/Goodell/annotations/Goodell_159_LncHSCs.liftOver.mm39.bed'
system(paste0("ln -s '",source_data,"' ",linkdir))
...
source_data <- '/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/metadata_RNA_seq_studies/Goodell/503_novel_lncRNAs.liftOver.mm39.bed'
system(paste0("ln -s '",source_data,"' ",linkdir))

# Klimmeck data
linkdir="data/public_data/lncRNA_studies/Klimmeck_et_al"
dir.create(linkdir)
source_data <- '/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/metadata_RNA_seq_studies/Klimmeck_et_al/stemcr205mmc5.chr.liftovermm39.gtf'
system(paste0("ln -s '",source_data,"' ",linkdir))

# Qian data
linkdir="data/public_data/lncRNA_studies/Qian_et_al"
dir.create(linkdir)
source_data <- '/run/user/1608803857/gvfs/smb-share:server=10.110.20.7,share=bdcuartero/CUARTERO GROUP/Lucia/Marie_Curie/public_datasets/metadata_RNA_seq_studies/Qian_et_al/Qian_genes_new_lncRNAs.liftovermm39.bed'
system(paste0("ln -s '",source_data,"' ",linkdir))
...
linkdir="data/public_data/CPAT_files"
dir.create(linkdir)
source_data <- "/home/llorenzi/Documentos/references/CPAT_files/Mouse_Hexamer.tsv"
system(paste0("ln -s '",source_data,"' ",linkdir))
source_data <- "/home/llorenzi/Documentos/references/CPAT_files/Mouse_logitModel.RData"
system(paste0("ln -s '",source_data,"' ",linkdir))

# GENCODE vm36 gtf
linkdir="data/references/gencode_vM36/"
dir.create(linkdir)
source_data <- "/home/llorenzi/Documentos/references/gencode.vM36.annotation.gtf"
system(paste0("ln -s '",source_data,"' ",linkdir))
