...
exp_path="outputs/expression_data/LSK_StemLinc.combined.20240930_173216.filtered.gene_name.all_blood_cells.txt"
exp_dir="outputs/expression_data/"
featC <- read.table(exp_path,header = T)
head(featC)
#modify sample names ----
inputbams=read.table("outputs/expression_data/all_public_and_SL_bams_oct2024.txt")
